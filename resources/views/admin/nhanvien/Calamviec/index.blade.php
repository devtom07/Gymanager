                     ...
                     <div class="table-rep-plugin">
                        ...
                        <div class="btn-toolbar">
                              <div class="btn-group dropdown-btn-group pull-right">
                                 <button type="button" class="btn btn-default"><a href="{{route('calamviec.add')}}" class="active">Tạo mới</a></button><button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">Hiện thêm thông tin <span class="caret"></span></button>
                                 ...
                                 <table id="tech-companies-1-clone" class="table table-striped">
                                    <thead>
                                       <tr>
                                          ...
                                          <th data-priority="1" id="tech-companies-1-col-1-clone">Tên ca làm việc</th>
                                          <th data-priority="3" id="tech-companies-1-col-2-clone">Ngày tạo</th>
                                          <th data-priority="1" id="tech-companies-1-col-3-clone">Giờ làm việc</th>
                                          <th data-priority="3" id="tech-companies-1-col-4-clone">Giờ kết thúc</th>
                                    ...
                                    <tbody>
                                       <tr>
                                          ...
                                          <td data-org-colspan="1" data-priority="1" data-columns="tech-companies-1-col-1">01/11/2020</td>
                                          <td data-org-colspan="1" data-priority="3" data-columns="tech-companies-1-col-2">08:30</td>
                                          <td data-org-colspan="1" data-priority="1" data-columns="tech-companies-1-col-3">15:30</td>
                                          <td data-org-colspan="1" data-priority="3" data-columns="tech-companies-1-col-4"><button type="button" class="btn btn-success btn-rounded waves-effect waves-light">Còn hiệu lực</button></td>
                                          ...
                                          <tr>
                                          <th data-org-colspan="1" data-columns="tech-companies-1-col-0"> <span class="co-name">Ca chiều</span></th>
                                          <td data-org-colspan="1" data-priority="1" data-columns="tech-companies-1-col-1">01/11/2020</td>
                                          <td data-org-colspan="1" data-priority="3" data-columns="tech-companies-1-col-2">15:30</td>
                                          <td data-org-colspan="1" data-priority="1" data-columns="tech-companies-1-col-3">21:30</td>
                                          <td data-org-colspan="1" data-priority="3" data-columns="tech-companies-1-col-4"><button type="button" class="btn btn-success btn-rounded waves-effect waves-light">Còn hiệu lực</button></td>
                                          <td data-org-colspan="1" data-priority="6" data-columns="tech-companies-1-col-8">
                                          <div class="btn-group mt-1 mr-1">
                                                    <button class="btn btn-success btn-sm dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
