                            ...
                            <div class="col-xl-6">
                                <form action="{{ route('customer_accounts.edit', $customer_account->id) }}" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="name" value="{{  $customer_account->name }}" id="example-time-input">
                                    </div>
                                    @error('name')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control"  name="id_customer" >
                                            ...
                                            <option 
                                            	<?php if($customers->id == $customer_account->id_customer) :?>
                                            	selected
                                            	<?php endif ?>	
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="email" value="{{ $customer_account->email }}" class="form-control">
                                    </div>
                                    @error('email')
                                    <p style="color:red">{{$message}}</p>
                                    @enderror
