@extends('admin.main')
@section('title','Xem thông tin tài khoản')
@section('content')
                                ...
                                <div class="image-container">
                                    ...
                                    @else
                                        <img src="http://placehold.it/150x150" id="imgProfile"
                                             style="width: 150px; height: 150px" class="img-thumbnail"/>
                                    @endif
                                    <form action="{{route('user.updateImage',$user->id)}}" method="post"
                                        ...
                                        <form method="post" action="{{route('user.update',$user->id)}}">
                                            ...
                                            <div class="tab-pane fade show active" id="basicInfo" role="tabpanel"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8 col-6">
                                                        <input class="form-control {{$errors->first('email') ? 'is-invalid': ''}}" type="text" name="email"
                                                               value="{{$user->email}}"/>
                                                        @if($errors->first('email'))
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-3 col-md-2 col-5">
                                                        <label style="font-family: inherit">Password</label>
                                                    </div>
                                                    <div class="col-md-8 col-6">
                                                        <input class="form-control {{$errors->first('password') ? 'is-invalid': ''}}" type="text" name="password" />
