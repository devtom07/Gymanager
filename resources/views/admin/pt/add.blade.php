    ...
    <div class="content">
        ...
        <div class="container-fluid">
                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Tạo mới PT</li>
                            </ol>
                        </div>
                        <h4 class="page-title">Tạo mới PT</h4>
                    </div>
                </div>
            </div>
            <!-- end page title --> 
            <div class="row">
                <div class="col-12">
                    <div class="card-box">
                        <h4 class="header-title mb-4">Tạo mới PT</h4>
                        <form action="{{route('pt.store')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="id_card" id="exampleInputPassword1" placeholder="chứng minh thư">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Ngay cap (*)</label>
                                        <input type="date" class="form-control" name="issued_on" id="exampleInputPassword1" placeholder="ngay cap">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Noi cap (*)</label>
                                        <input type="text" class="form-control" name="issued_by" id="exampleInputPassword1" placeholder="noi cap">
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="start_day" id="exampleInputPassword1" placeholder="ngày bắt đầu">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Ngày kết thúc (*)</label>
                                        <input type="date" class="form-control" name="end_day" id="exampleInputPassword1" placeholder="ngày kết thúc">
                                    </div>
                                    <div class="form-group">
                                        <label>Địa chỉ</label>
