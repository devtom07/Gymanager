               ...
               <div class="page-title-box">
                  <div class="page-title-right">
                     <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Danh sách PT</li>
                     </ol>
                  </div>
                  <h4 class="page-title">Danh sách PT</h4>
               </div>
            </div>
         </div>
         <!-- end page title --> 
                        ...
                        <div class="table-wrapper">
                           <div class="btn-toolbar">
                              <div class="btn-group dropdown-btn-group pull-right">
                                 <button type="button" class="btn btn-default"><a href="{{route('pt.add')}}" class="active">Tạo mới</a></button><button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">Hiện thêm thông tin <span class="caret"></span></button>
                                    ...
                                    <tbody>
                                       @foreach($listPt as $key => $pt)
                                          <tr>
                                             ...
                                             {{-- <td data-org-colspan="1" data-priority="1" data-columns="tech-companies-1-col-1">
                                             <img src="{{asset('staff/'.$pt->avatar)}}" width="100" height="100" alt="">
                                             </td> --}}
                                             <td data-org-colspan="1" data-priority="1" data-columns="tech-companies-1-col-1">
                                                {{ $pt->phone}}
                                             </td>
                                             ...
                                             <td data-org-colspan="1" data-priority="6" data-columns="tech-companies-1-col-8">
                                                <div class="btn-group mt-1 mr-1">
                                                   ...
                                                   <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 29px, 0px);">
                                                      <a class="dropdown-item" href="{{route('pt.show',$pt->id)}}">
                                                         <i class="mdi mdi-lead-pencil"></i> 
                                                            Chi tiết
                                                      </a>
                                                      <a class="dropdown-item" href="{{route('pt.edit',$pt->id)}}">
                                                         <i class="mdi mdi-lead-pencil"></i> 
                                                            Sửa
                                                      </a>
                                                      <a class="dropdown-item btn-remove" href="{{route('pt.delete',$pt->id)}}">
