                                    ...
                                    <div class="col-md-6">
                                        <div class="card-box">
                                            ...
                                            <div class="inbox-widget slimscroll" style="max-height: 324px;">
                                                ...
                                                <a href="#">
                                                    <div class="inbox-item">
                                                        <div class="inbox-item-img"><img src="{{url('admin')}}/images/users/avatar-6.jpg" class="rounded-circle" alt=""></div>
                                                ...
                                                <a href="#">
                                                    <div class="inbox-item">
                                                        <div class="inbox-item-img"><img src="{{url('admin')}}/images/users/avatar-8.jpg" class="rounded-circle" alt=""></div>
                                                ...
                                                <a href="#">
                                                    <div class="inbox-item">
                                                        <div class="inbox-item-img"><img src="{{url('admin')}}/images/users/avatar-9.jpg" class="rounded-circle" alt=""></div>
