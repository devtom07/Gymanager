                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <form action="{{route('ptProgram.update',$ptPrograms->id)}}" method="post">
                                        ...
                                        <select name="customer" class="custom-select mb-3">
                                            ...
                                            @foreach($customer as $customers)
                                                @if($customers->customer->id == $ptPrograms->customer_id)
                                                    <option selected
                                                            value="{{$customers->customer->id}}">{{$customers->customer->name}}</option>
                                                @else
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="{{$ptPrograms->number_sessions}}" type="number"
                                               class="form-control"
                                               id="number_sessions"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="{{$ptPrograms->total}}" type="number"
                                               class="form-control totalCustomer"
                                               id="totalCustomer"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="{{$ptPrograms->money_paid}}" type="number" min="0 "
                                               class="form-control"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="status" class="custom-select mb-3">
                                            @if($ptPrograms->status == 'Đang thuê')
                                                <option selected value="Đang thuê">Đang thuê</option>
                                                <option value="Đã xong">Đã xong</option>
                                                <option value="Đã chuyển">Đã chuyển</option>
                                                <option value="Hủy">Hủy</option>
                                                <option value="Hết hạn">Hết hạn</option>
                                                <option value="Bảo lưu">Bảo lưu</option>
                                            @elseif($ptPrograms->status == 'Đã xong')
                                                <option value="Đang thuê">Đang thuê</option>
                                                <option selected value="Đã xong">Đã xong</option>
                                                <option value="Đã chuyển">Đã chuyển</option>
                                                <option value="Hủy">Hủy</option>
                                                <option value="Hết hạn">Hết hạn</option>
                                                <option value="Bảo lưu">Bảo lưu</option>
                                            @elseif($ptPrograms->status == 'Đã chuyển')
                                                <option value="Đang thuê">Đang thuê</option>
                                                <option value="Đã xong">Đã xong</option>
                                                <option selected value="Đã chuyển">Đã chuyển</option>
                                                <option value="Hủy">Hủy</option>
                                                <option value="Hết hạn">Hết hạn</option>
                                                <option value="Bảo lưu">Bảo lưu</option>
                                            @elseif($ptPrograms->status == 'Hủy')
                                                <option value="Đang thuê">Đang thuê</option>
                                                <option value="Đã xong">Đã xong</option>
                                                <option value="Đã chuyển">Đã chuyển</option>
                                                <option selected value="Hủy">Hủy</option>
                                                <option value="Hết hạn">Hết hạn</option>
                                                <option value="Bảo lưu">Bảo lưu</option>
                                            @elseif($ptPrograms->status == 'Hết hạn')
                                                <option value="Đang thuê">Đang thuê</option>
                                                <option value="Đã xong">Đã xong</option>
                                                <option value="Đã chuyển">Đã chuyển</option>
                                                <option value="Hủy">Hủy</option>
                                                <option selected value="Hết hạn">Hết hạn</option>
                                                <option value="Bảo lưu">Bảo lưu</option>
                                            @else
                                                <option value="Đang thuê">Đang thuê</option>
                                                <option value="Đã xong">Đã xong</option>
                                                ...
                                                <option value="Hủy">Hủy</option>
                                                <option value="Hết hạn">Hết hạn</option>
                                                <option selected value="Bảo lưu">Bảo lưu</option>
                                            @endif
                                        </select>
                            ...
                            <div class="col-xl-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input value="{{$ptPrograms->time}}" type="number" class="form-control" id="time"
                                           name="time"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="mt-3">
                                        @if($ptPrograms->pay == 'tiền mặt')
                                        <div class="custom-control custom-radio">
                                            <input checked value="tiền mặt" type="radio" id="customRadio1" name="customRadio"
                                                   class="custom-control-input">
                                            <label class="custom-control-label" for="customRadio1">Tiền mặt</label>
                                        </div>
                                        <div class="custom-control custom-radio">
                                            <input value="chuyển khoản" type="radio" id="customRadio2"
                                                   name="customRadio"
                                        ...
                                        @else
                                            ...
                                            <div class="custom-control custom-radio">
                                                <input checked value="chuyển khoản" type="radio" id="customRadio2"
                                                       name="customRadio"
                                                       class="custom-control-input" value="Click">
                                                <label class="custom-control-label " for="customRadio2">Tài khoản ngân
                                                    hàng</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input value="{{$ptPrograms->still_owe}}" type="number" class="form-control"
                                           id="still_owe"
                                           name="still_owe"
                                           placeholder="Còn nợ">
                                ...
                                <div class="form-group">
                                    ...
                                    <input value="{{$ptPrograms->end_date}}" type="date" class="form-control"
