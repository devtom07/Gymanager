                            ...
                            <div class="card mb-0">
                                <div class="card-body p-4">
                                    ...
                                    <form method="post" action="{{route('login')}}" class="mt-2">
                                        ...
                                        if ($message){
                                            echo'<span style="color: red;margin-left: 45px" class="text-alert">',$message,'</span>' ;
                                            Session::put('message',null);
                                        }

                                        ?>
                                        <div class="form-group mb-3">
                                            <input name="email" class="form-control" type="text" required="" placeholder="Enter your username">
                                        </div>
