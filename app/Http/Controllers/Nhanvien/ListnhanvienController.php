...
class ListnhanvienController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.nhanvien.list-nhanvien.index',['listStaff'=>$listStaffs]);
    ...
    public function edit($id)
    {
        $listTitle = Title::all();
        $listStaffs = Staff::find($id);
        return view('admin.nhanvien.list-nhanvien.edit',['listStaffs'=>$listStaffs, 'listTitle'=>$listTitle]);
    }
